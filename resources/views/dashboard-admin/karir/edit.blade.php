                           ...
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="number" class="form-control @error('batas_ipk') is-invalid @enderror" id="batas_ipk" name="batas_ipk" value="{{ old('batas_ipk', $karir->batas_ipk) }}" placeholder="Contoh: 3.00" step="0.01" min="0" max="4.00" required/>
                                    @error('batas_ipk')
                                       <div class="invalid-feedback">
                                             {{ $message }}
                                       </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <select class="form-control @error('jurusan_id') is-invalid @enderror" id="jurusan" name="jurusan_id" required autofocus value="{{ old('jurusan_id', $karir->jurusan->name) }}">
                                    ...
                                    @foreach($jurusans as $data)
                                       <option value="{{ $data->id }}" {{ (old('type_id', $karir->jurusan_id) ?? '') == $data->id ? 'selected' : '' }}>
                                             {{ $data->name }}
                                       </option>
                                    @endforeach
                                 </select>
